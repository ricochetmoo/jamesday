<x-app-layout>
	<x-slot name="header">
		...
		<div class="inline-block mx-3">
			<a class="block bg-indigo-700 rounded px-4 py-2 font-bold text-white hover:bg-indigo-500 transition text-lg text-center" href="{{url('/admin/invites')}}">Back to List</a>
		</div>
